...
def process_files(primary_file, secondary_file, workflow="normal", output_file=None):
    """
    ...
    """
    if workflow == "normal":
        return process_normal_files(primary_file, secondary_file, output_file)

    if workflow == "iterative":
        return process_iterative_files(primary_file, secondary_file, output_file)
